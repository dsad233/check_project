...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('최고관리자', '관리자', name='user_role'), nullable=False),
    ...
    op.create_index('idx_leave_category_branch_id', 'leave_categories', ['branch_id'], unique=False)
    op.create_index('idx_leave_category_date', 'leave_categories', ['date'], unique=False)
