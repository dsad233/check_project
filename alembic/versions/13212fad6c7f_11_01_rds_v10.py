...
Revision ID: 13212fad6c7f
Revises: 
Create Date: 2024-11-01 22:15:35.148473
...
def upgrade() -> None:
    ...
    op.create_table('connection_logs', sa.Column('id', sa.Integer(), autoincrement=True, nullable=False), 
    ...
    sa.Column('base_salary', sa.Boolean(), server_default=sa.text('0'), nullable=True),
    ...
    sa.Column('is_additional_holiday_hundred', sa.Boolean(), nullable=True),
    sa.Column('is_unused_annual_leave_hundred', sa.Boolean(), nullable=True),
    sa.Column('is_annual_leave_deduction_hundred', sa.Boolean(), nullable=True),
    sa.Column('is_attendance_deduction_hundred', sa.Boolean(), nullable=True),
    sa.Column('display_meal_calc', sa.Boolean(), nullable=True),
    sa.Column('display_night_calc', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_yn', sa.String(length=1), nullable=True),
    sa.ForeignKeyConstraint(['branch_id'], ['branches.id'], ),
    ...
    sa.Column('sabbatical_start_date', sa.Date(), nullable=True),
    sa.Column('sabbatical_end_date', sa.Date(), nullable=True),
    sa.Column('resignation_date', sa.Date(), nullable=True),
    sa.Column('total_leave_days', sa.Numeric(precision=10, scale=2), nullable=True),
    sa.Column('remaining_annual_leave', sa.Integer(), server_default=sa.text('0'), nullable=True),
    ...
    sa.Column('role', sa.Enum('MSO 최고권한', '최고관리자', '통합관리자', '관리자', '사원', '퇴사자', '휴직자', '임시생성', name='user_role'), nullable=False),
    sa.Column('position', sa.Enum('MSO 최고권한', '최고관리자', '통합관리자', '관리자', '사원', '퇴사자', '휴직자', '임시생성', name='user_position'), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending', 'approved', 'rejected', name='leave_history_status'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_yn', sa.String(length=1), nullable=True),
    sa.ForeignKeyConstraint(['branch_id'], ['branches.id'], ),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('contract_creation_date', sa.Date(), nullable=False),
    sa.Column('contract_start_date', sa.Date(), nullable=False),
    ...
    sa.Column('modusign_id', sa.String(length=255), nullable=True),
    sa.Column('contract_url', sa.String(length=255), nullable=False),
    sa.Column('contract_status', sa.Enum('PENDING', 'APPROVE', 'REJECT', 'CANCEL', name='contractstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_yn', sa.String(length=1), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('contract_url'),
    sa.UniqueConstraint('modusign_id')
    )
