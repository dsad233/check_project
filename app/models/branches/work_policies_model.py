...
class WorkPolicies(Base):
    ...
    work_schedules = relationship("WorkSchedule", back_populates="work_policy", lazy="selectin")
    break_times = relationship("BreakTime", back_populates="work_policy", lazy="selectin")
