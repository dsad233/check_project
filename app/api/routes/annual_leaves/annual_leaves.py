...
from app.models.users.leave_histories_model import AnnualLeave
...
@router.get("")
async def getAnnualLeave(current_user: Users = Depends(validate_token)):
    try:
        query = (
            select(AnnualLeave)
            .options(
            ...
            .where(
                AnnualLeave.proposer_id == current_user.id,
