...
async def create(*, session: AsyncSession, branch_id: int, request: AccountBasedAnnualLeaveGrant = AccountBasedAnnualLeaveGrant()) -> AccountBasedAnnualLeaveGrant:
...
async def update(*, session: AsyncSession, branch_id: int, request: AccountBasedAnnualLeaveGrant, old: AccountBasedAnnualLeaveGrant) -> bool:
